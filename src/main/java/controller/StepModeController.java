...
public class StepModeController {
    ...
    public void printInfo(List<String> eventCalendar, List<List<SourceResult>> sourcesStates, List<List<BufferResult>> bufferStates, List<List<DeviceResult>> devicesStates) {
        step = 0;
